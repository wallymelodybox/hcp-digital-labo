  ...
  return (
    <div className="public-theme bg-[#06090A] text-white min-h-screen">
            ...
            >
              <div className="relative aspect-4/5 overflow-hidden rounded-4xl border border-white/10 bg-white/3.5 shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-400/10 px-4 py-2 text-xs font-bold tracking-widest text-blue-300 backdrop-blur-md uppercase">
                    Pôle {number}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, idx) => (
              <div key={service.name} className="group">
                <PremiumCard className="p-8 h-full transition-all hover:-translate-y-1 hover:border-blue-400/30">
                  <div className="absolute -right-2 -top-4 text-6xl font-bold text-white/5 group-hover:text-blue-400/10 transition-colors">
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="relative overflow-hidden rounded-3xl border border-blue-400/20 bg-blue-400/10 p-8 md:p-12 text-center">
        ...
        <div className="mx-auto max-w-6xl px-5">
          <div className="grid grid-cols-2">
            {prevPole ? (
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 text-white/40 transition-colors group-hover:border-blue-400/30 group-hover:text-blue-300">
