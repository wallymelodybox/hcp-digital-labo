          ...
          <div className="grid gap-8 md:grid-cols-12">
            <div className="md:col-span-5">
              ...
              <div className="mt-6 space-y-3 rounded-3xl border border-white/10 bg-white/3 p-6">
                <div className="text-sm text-white"><span className="text-white/60">Email :</span> <span className="font-semibold">contact@hcp-digital-lab.org</span></div>
                <div className="text-sm text-white"><span className="text-white/60">Téléphone :</span> <span className="font-semibold">07 68 30 70 80</span></div>
